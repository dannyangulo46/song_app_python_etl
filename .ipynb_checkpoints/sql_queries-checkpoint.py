...
artist_table_create = ("""
    ...
    (artist_id varchar PRIMARY KEY, name varchar, location varchar, latitude decimal, longitude decimal);
""")

time_table_create = ("""
    CREATE TABLE IF NOT EXISTS time
    (start_time time NOT NULL PRIMARY KEY, hour numeric, day numeric, week numeric, month varchar, year int, weekday varchar);
""")
